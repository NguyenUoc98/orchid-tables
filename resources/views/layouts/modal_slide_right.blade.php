@push('modals-container')
    <div class="modal fade slide-right"
         id="screen-modal-{{$key}}"
         role="dialog"
    ...
    >
        <div class="modal-dialog modal-fullscreen-md-down modal-dialog-scrollable h-100 m-0 ms-auto {{$size}} {{$type}}"
             role="document"
             id="screen-modal-type-{{$key}}"
        >
            <form class="modal-content h-100"
                  action="{{ $method }}"
